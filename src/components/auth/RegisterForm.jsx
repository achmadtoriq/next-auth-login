    ...
    return (
        <form action={formAction} className='space-y-6'>
            ...
            <div className="">
                ...
                <input type="text" name='name' className='bg-gray-50 border border-gray-300 text-gray-900 rounded-lg w-full p-2.5' placeholder='John Doe' />
            ...
            <div className="">
                ...
                <input type="password" name='ConfirmPassword' className='bg-gray-50 border border-gray-300 text-gray-900 rounded-lg w-full p-2.5' placeholder='******' />
                <div aria-live='polite' aria-atomic="true">
